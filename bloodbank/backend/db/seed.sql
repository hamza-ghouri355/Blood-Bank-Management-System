...
('Hamza Tariq', 'O-', 'Male', '2001-06-30', '03333334444', 'hamza.tariq@example.com', 'Lahore', NULL, 'Eligible');
...
-- Blood Inventory (mix of available, soon-expiring, and expired)
...
('A+', 450, '2026-05-20', '2026-06-18', 'Fridge A2', 'Available', 2),
('B-', 450, '2026-06-10', '2026-07-22', 'Fridge B1', 'Available', 3),
('AB+', 450, '2026-04-01', '2026-05-13', 'Fridge B2', 'Expired', 4),
('O-', 450, '2026-06-08', '2026-06-20', 'Fridge A1', 'Available', 5),
('O+', 450, '2026-06-05', '2026-06-19', 'Fridge A1', 'Available', NULL),
('A-', 450, '2026-06-09', '2026-07-21', 'Fridge A3', 'Available', NULL),
('B+', 450, '2026-06-12', '2026-07-24', 'Fridge B3', 'Available', NULL);

-- Donations (linking donors to inventory units they donated)
